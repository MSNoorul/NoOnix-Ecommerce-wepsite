...
function Banner() {
    ...
    return ( 
        <div className='  container overflow-hidden h-[70vh] px-2 mx-auto mb-11 relative'>
            <div className=' absolute w-full h-full flex flex-col justify-center items-center'>
                ...
                <button onClick={()=>IncCartItem(data[0].id,data[0])} className=" bg-slate-100 rounded-[25px] px-3 py-2 font-semibold text-slate-600"> shop now</button>
            </div>
