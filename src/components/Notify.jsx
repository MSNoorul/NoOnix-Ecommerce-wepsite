function Notify({title}) {
    ...
    py-3 px-6 rounded-[30px] border border-slate-200 w-fit flex gap-4 ">
       <p className=" p-1 bg-green-600 text-white rounded-[50%] w-fit"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
