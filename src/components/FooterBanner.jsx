...
function FooterBan() {
    return ( 
        <div className=" container mx-1 sm:mx-auto bg-red-600  rounded-xl mt-32
        pt-32 flex flex-col xl:flex-row pb-12 justify-center items-center xl:justify-between px-1 lg:px-6  text-white relative ">
            ...
            <div >
                <img className=" xl:absolute  top-[-65px] left-1/3 xl:translate-x-[-30%] w-[350px] lg:w-[350px] h-[350px]  "
