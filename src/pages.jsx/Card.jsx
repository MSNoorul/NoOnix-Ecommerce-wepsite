    ...
    >
      ...
      >
        <p className=" mb-8 font-medium capitalize text-slate-800">
          &#60; your card with &#40;<span className=" text-red-600">{Total.Tamount} items</span>
          &#41;
        </p>
        {cartItem.map(item =>{
          return (
            <div key={item.id} className=" card-grid mb-3">
            <img className=" rounded-md w-32  h-32 border border-solid border-slate-200" src={item.url[0]} alt="img" />
            ...
            <p className=" text-xl text-slate-700  font-medium">{item.price}</p>
